    ...
    <div class="container">
        ...
        <div class="view-container">
            <?php if (!empty($item['image_path']) && file_exists($item['image_path'])): ?>
                <img src="<?php echo htmlspecialchars($item['image_path']); ?>" alt="<?php echo htmlspecialchars($item['item_name']); ?>" class="product-image-large">
            <?php else: ?>
                <div class="product-image-placeholder">
                    <i class="fas fa-image"></i>
                    <p style="font-size: 14px; margin-top: 10px;">No Image Available</p>
                </div>
            <?php endif; ?>
