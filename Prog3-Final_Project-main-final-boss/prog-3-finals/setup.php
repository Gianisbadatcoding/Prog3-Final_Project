...
<body>
    <div class="container">
        ...
        try {
            ...
            // Create items table (includes ownership, category, status, and image path)
            ...
            if ($conn->query($sql) === TRUE) {
                $success[] = "Table 'transactions' created or already exists.";
            } else {
            ...
            if ($conn->query($sql) === TRUE) {
                $success[] = "Table 'transaction_items' created or already exists.";
            } else {
                throw new Exception("Error creating transaction_items table: " . $conn->error);
            }
