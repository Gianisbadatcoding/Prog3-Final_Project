...
<head>
    ...
    <style>
        ...
        th { 
            background-color:rgb(24, 227, 115); 
            color: white; 
            padding: 8px 5px; 
            text-align: left;
            font-weight: bold;
        ...
        .print-btn {
            background: linear-gradient(135deg,rgb(24, 227, 132) 0%,rgb(20, 95, 192) 100%);
            color: white;
            padding: 10px 20px;
            border: none;
            border-radius: 5px;
        ...
        .print-btn:hover {
            background: linear-gradient(135deg,rgb(20, 192, 112) 0%,rgb(16, 83, 160) 100%);
        }
    </style>
    <script>
        function printPDF() {
